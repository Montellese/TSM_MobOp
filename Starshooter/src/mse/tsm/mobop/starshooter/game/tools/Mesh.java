...
public final class Mesh
{
  ...
  public Mesh(GL10 gl, int numVertices, boolean hasColors,
  ...
  private void update()
  {
    ...
    } else
    {
      ...
      gl.glBufferData(GL11.GL_ARRAY_BUFFER, vertices.length * 4, vertexBuffer,
      ...
      if (normals != null)
      {
        ...
        gl.glBufferData(GL11.GL_ARRAY_BUFFER, normals.length * 4, normalBuffer,
            GL11.GL_DYNAMIC_DRAW);
      }
  ...
  /**
   * Returns the OpenGL constant for the given primitive type
   * @param type the type
