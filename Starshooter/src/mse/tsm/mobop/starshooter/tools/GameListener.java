...
/**
 * A GameListener is the main mean of implementing the game. It is attached to a
 * {@link GameActivity} and will be called whenever a frame has to be rendered
 * or the game needs to be initialized.
 * 
 * @author mzechner
 * 
 */
